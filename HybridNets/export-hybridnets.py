...
#m = torch.load(weight, map_location=device)
torch.save(model.state_dict(), 'weights/hybridnets.pt')
model.load_state_dict(torch.load('weights/hybridnets.pt', map_location=device))
